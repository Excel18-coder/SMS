...
import ShowTimetables from "./timetableRelated/ShowTimetables";
...
import AddBook from "./libraryRelated/AddBook";
import ShowLibrary from "./libraryRelated/ShowLibrary";

import ComposeMessage from "./messageRelated/ComposeMessage";
import ShowMessages from "./messageRelated/ShowMessages";
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={styles.boxStyled}>
          ...
          <Routes>
            ...
            {/* Timetables */}
            <Route path="/Admin/timetables" element={<ShowTimetables />} />
            ...
            {/* Library */}
            <Route path="/Admin/library" element={<ShowLibrary />} />
            <Route path="/Admin/addbook" element={<AddBook />} />

            {/* Messages */}
            <Route path="/Admin/messages" element={<ShowMessages />} />
            <Route path="/Admin/composemessage" element={<ComposeMessage />} />
