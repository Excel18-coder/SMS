    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Admin/timetables">
                    <ListItemIcon>
                        <ScheduleIcon color={location.pathname.startsWith("/Admin/timetables") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                ...
                <ListItemButton component={Link} to="/Admin/library">
                    <ListItemIcon>
                        <LibraryBooksIcon color={location.pathname.startsWith("/Admin/library") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
